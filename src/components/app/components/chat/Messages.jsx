    ...
    <div className="messages mb-2">
      <div className="user p-2">
        <UserAvatar
          ...
          size={40}
        />
        <NavLink to={`/profile/${props.user.initials}/${props.user.tag}`}>
          <span className="name">
  ...
  return (
    <div
      className={
        ...
        (props.sended === "1" ? "sender float-right" : "reciever float-left")
      }
    >
...
export function RenderChats(props) {
  return (
    <div
      className={
        "user-chat" + (props.selected === props.user.id ? " active" : "")
      }
      id={props.user.id}
      ...
      <div className={"user-box p-2 "}>
        ...
        <div className="row">
          ...
          <small className="d-none d-md-block message">
            {props.message.message.substring(0, props.chatsLength)}
            {props.message.message.length > props.chatsLength && "..."}
          </small>
        </div>
      </div>
    </div>
